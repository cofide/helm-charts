...
The Chart.yaml version fields should be updated as follows:
- version: the chart version (increment on any chart change)
- appVersion: the deployed application version (increment only when the application version changes)
