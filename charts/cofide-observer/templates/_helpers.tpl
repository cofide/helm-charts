...
*/}}
{{- define "cofide-observer.fullname" -}}
...
Common labels
*/}}
{{- define "cofide-observer.labels" -}}
helm.sh/chart: {{ include "cofide-observer.chart" . }}
{{ include "cofide-observer.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "cofide-observer.selectorLabels" -}}
app.kubernetes.io/name: {{ include "cofide-observer.name" . }}
...
*/}}
{{- define "cofide-observer.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "cofide-observer.fullname" .) .Values.serviceAccount.name }}
{{- else }}
